...
.bg {
  /* The image used */
  background-image: url("img/fa1.jpg");
...
window.open("fviewBread.jsp","_self");
</script>
<%
}else{
%>
...
<table   width="1185" height="426" border="0" align="center">
  <tr>
   <td width="490" height="416"></td>
    <td width="596"><div align="justify">
     <h3 align="center" style="color:blue">Farmer Login Page</h3>
    ...
    <table style="background-color:#666666; border-radius:25px" width="621" border="0" align="center">
      <tr>
        <td><span class="style3">
          ...
          <div align="right" class="style3">Enter Phone
            </label>
          </div></td>
        <td><input type="text"  name="username" placeholder="Phone Number" /></td>
      </tr>
      <tr>
        <td><span class="style3">
          <label for="lname">
...
<a href="customerReg.jsp" >Registration</a>
